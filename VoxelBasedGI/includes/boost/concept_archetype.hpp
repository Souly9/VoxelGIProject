...
#define BOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(OP, NAME) \
  ...
  { \
	...
	{
		using Return = boolean_archetype;
	...
	{
	public:
		using self = output_iterator_archetype;
	public:
		using iterator_category = std::output_iterator_tag;
		using value_type = output_proxy<T>;
		using reference = output_proxy<T>;
		using pointer = void;
	...
	{
	public:
		using self = mutable_forward_iterator_archetype;
	public:
		using iterator_category = std::forward_iterator_tag;
		using value_type = T;
		using reference = T&;
	...
	{
	public:
		using self = bidirectional_iterator_archetype;
	public:
	...
	{
	public:
		using self = mutable_bidirectional_iterator_archetype;
	public:
		using iterator_category = std::bidirectional_iterator_tag;
		using value_type = T;
		using reference = T&;
	...
	{
	public:
		using self = random_access_iterator_archetype;
	public:
	...
	{
	public:
		using self = mutable_random_access_iterator_archetype;
	public:
		using iterator_category = std::random_access_iterator_tag;
		using value_type = T;
		using reference = T&;
